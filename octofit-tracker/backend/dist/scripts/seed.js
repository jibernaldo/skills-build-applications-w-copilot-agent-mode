...
async function seedDatabase() {
    try {
        ...
        await User_1.default.updateMany({ _id: { $in: [users[0]._id, users[1]._id, users[3]._id] } }, { teamId: teams[0]._id });
        await User_1.default.updateMany({ _id: { $in: [users[2]._id, users[4]._id] } }, { teamId: teams[1]._id });
        ...
        const leaderboardEntries = await Leaderboard_1.default.create(leaderboardData);
